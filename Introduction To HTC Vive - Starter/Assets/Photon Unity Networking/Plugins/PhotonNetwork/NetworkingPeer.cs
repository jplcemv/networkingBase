...
internal class NetworkingPeer : LoadBalancingPeer, IPhotonPeerListener
{
    ...
    public bool canRelinquishOwnership = false;
    public float timer = 0.0f;

    public bool getCanRelinquishOwnership()
    {
        return canRelinquishOwnership;
    }
...
#region Operations and Connection Methods
    ...
    public void RunViewUpdate()
    {
        ...
        if (countOfUpdatesToSend == 0)
        {
            ...
            if (timer >= 1.0f)
            {
                Debug.Log("can relinquish ownership");
                canRelinquishOwnership = true;
            }
            return;
        }
        else
